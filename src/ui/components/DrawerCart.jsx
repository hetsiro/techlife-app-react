...
export const DrawerCart = ({ open, setOpenCart }) => {
  ...
  return (
    <>
      <Drawer anchor="right" open={open} onClose={() => setOpenCart(false)}
      >
        <Grid2 container justifyContent='center' alignItems='center' backgroundColor='primary.main' px={3}width='100%'>
        ...
        <Grid2 container direction='column' justifyContent='center' alignItems='center' spacing={2} p={4} flexGrow={1}>
          {cart.map((item) => {
            return (
        ...
        <Grid2 container justifyContent='center' alignItems='center' backgroundColor='primary.main' py={2}>
